...
export class TProtocolException implements Error {
  ...
  /**
   * Initializes a Thrift TProtocolException instance.
   * @param {string} message - The TProtocolException message (distinct from the Error message).
   */
...
export class TBase {
  read(protocol: TProtocol): void;
  write(protocol: TProtocol): void;
}
 ...
 */
export class TXHRTransport extends TTransport {
  url: string;
  wpos: number;
  rpos: number;
  useCORS: any;
 ...
 */
export class TWebSocketTransport extends TTransport {
 ...
 */
export class TJSONProtocol extends TProtocol {
  transport: Object;
...
export class MultiplexProtocol extends TJSONProtocol {
  ...
  /**
   * Initializes a MutilplexProtocol Implementation as a Wrapper for Thrift.TProtocol.
   * @param {string} srvName
   * @param {Thrift.TTransport} trans
...
export class Multiplexer {
   ...
   * @param {Thrift.TTransport} transport - Thrift.Transport instance which provides remote host:port.
   */
